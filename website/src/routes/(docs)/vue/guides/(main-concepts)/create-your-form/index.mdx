...
> If your initial data comes from a remote source and may change after form creation, use the <Link href="/methods/api/reset/">`reset`</Link> method with a new `initialInput` to update the form's baseline data.
