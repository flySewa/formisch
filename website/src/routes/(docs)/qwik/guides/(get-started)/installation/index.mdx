...
Formisch includes an agent skill that teaches AI agents the correct patterns for working with Formisch forms. You can install it by running one of the following command in your terminal:
